...
public class Game {
    ...
    public void start() {
        while (true) {
            ...
            System.out.println("2. Orman --> Karşınıza belki ayı çıkabilir !");
            System.out.println("3. Mağara --> Karşınıza belki zombi çıkabilir !");
            System.out.println("4. Büyülü Şato --> Karşınıza belki vampir çıkabilir !");
            ...
            if (location.getClass().getName().equals("SafeHouse")) {
                if (player.getInv().isDiamond() && player.getInv().isFood() && player.getInv().isWater()) {
